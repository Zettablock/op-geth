...
coverpkg="github.com/ethereum/go-base/..."
...
repo=$GOPATH/src/github.com/ethereum/go-base
compile_fuzzer github.com/ethereum/go-base/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/ethereum/go-base/common/bitutil \
...
compile_fuzzer github.com/ethereum/go-base/eth/protocols/snap \
...
compile_fuzzer github.com/ethereum/go-base/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/ethereum/go-base/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/ethereum/go-base/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/ethereum/go-base/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
